  ...
  <div class="container">
	...
	<?php
		...
		if ($resultrug == 0) {
		  ...
		  if(($_SESSION['isadmin']) == 1) {
                  echo '<td><form method="post"><input type="hidden" name="update-user" value="'.$row->username.'"><button type="submit" class="btn  btn-primary btn-block" name="deluser-btn">Delete</button></form></td>'; }
                echo ' </tr>'; 
