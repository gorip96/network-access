...
<?php
	...
	echo '<div class="row">';
	echo '<div><h3>'.$row->groups.'</h3></div><div></div>';
	echo '<div><button type="submit" class="btn btn-primary btn-block" name="newgroupcheck-btn">New Group Check</button></div><div></div>';
